 ...
 * <p>2. 数组引用：把数组看作是一个特殊的类，则写法和构造器引用一致</p>
 * @author loriyuhv
...
public class ConstructorRefTest {
    ...
    * Employee空参构造器 */
    ...
    @Test
    public void test03() {
        BiFunction<Long, String, Employee> function = (id, name) -> new Employee(id, name);
        System.out.println(function.apply(1L, "Jerry"));

        BiFunction<Long, String, Employee> function2 = Employee::new;
        System.out.println(function2.apply(2L, "Jack"));
    }
